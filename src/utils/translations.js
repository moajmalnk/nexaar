export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitleMobile: 'We build websites, apps, and digital platforms for Saudi SMEs and startups. From idea to launch with speed and structure.',
  ...
  ar: {
    ...
    hero: {
      ...
      subtitleMobile: 'نبني المواقع، التطبيقات، والمنصات الرقمية للشركات السعودية الناشئة. من الفكرة إلى الإطلاق بسرعة ومنهجية.',
