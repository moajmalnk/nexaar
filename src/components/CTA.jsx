...
const CTA = () => {
  ...
  return (
    <section className="bg-brand-deep-navy py-16 md:py-32 relative overflow-hidden text-center">
      {/* Visual Anchor Glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="btn-cta group flex w-full max-w-sm md:w-auto md:max-w-none items-center justify-center space-x-4 rtl:space-x-reverse !px-6 md:!px-10 !py-5 rounded-2xl text-base md:text-xl focus:ring-coral"
          >
